...
public class ShellEmitter : MonoBehaviour {
    ...
    public float m_ShellScale = 1.0f;           // Relative scale of shell compared to parent
    ...
    private void Fire()
    {
        ...
        if (shellPrefab != null)
        {
            ...
            shellInstance.transform.localScale = new Vector3(m_ShellScale, m_ShellScale, m_ShellScale);
